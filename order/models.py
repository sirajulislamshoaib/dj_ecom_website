...
class Order(models.Model):
    ...
    order_items = models.ManyToManyField(OrderItem, blank=True, related_name="orderitem")
    ...
    status = models.CharField(max_length=20, choices=list(zip(STATUS, STATUS)), default='Received')
